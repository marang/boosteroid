...
For automated update checks (cron, systemd timer), use:
...
Use your preferred schedule, then commit the generated manifest change and open/update the PR in Flathub.
